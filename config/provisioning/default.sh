...
CHECKPOINT_MODELS=(
    ...
    "https://civitai.com/api/download/models/470417?type=Model&format=SafeTensor&size=pruned&fp=fp16"
)

LORA_MODELS=(
    "https://civitai.com/api/download/models/166049?type=Model&format=SafeTensor"
)
